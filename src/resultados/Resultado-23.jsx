...
import rutina3 from '../assets/rutinas/rutina-3DiasInf.webp'


const ResultadoVeintitres = () => {
    return (
        <>
            <main className='mx-4'>
                <section className='mt-16 flex flex-col items-baseline'>
                    ...
                    <article className='bg-zinc-900 rounded-xl p-2 sm:p-6 text-start text-lg sm:text-2xl'>
                        En este caso, la persona que genéticamente es mesomorfa y su objetivo es más enfocado a una recomposición corporal en la 
                        cual el aumento muscular es menos agresivo, puede centrarse en comer bien sin tener que hacerlo de una forma tan estricta.
                        Para estos casos te recomendamos que tu dieta se base en: <br />
                        ...
                        Grasas Saludables: Palta, nueces, semillas, aceite de oliva, pescado graso, mantequilla de maní. 20-30% de tu ingesta calórica
                        diaria. <br />
...
export default ResultadoVeintitres;