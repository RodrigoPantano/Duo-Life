            ...
            <main className='mx-4'>
                <section className='mt-16 flex flex-col items-baseline'>
                    ...
                    <article className='bg-zinc-900 rounded-xl p-2 sm:p-6 text-start text-lg sm:text-2xl'>
                        Una guía alimenticia para alguien que quiere ganar masa muscular pero tiene facilidad para ganar peso requiere un enfoque
                        ...
                        Carbohidratos Complejos y Fibra: Avena, arroz integral, quinoa, batata, legumbres, verduras. Prioriza los carbohidratos complejos y
                        con alto contenido en fibra para mantenerte saciado y evitar picos de azúcar en la sangre. <br />
                        ...
                        Micronutrientes: Frutas y verduras de todos los colores para asegurar una ingesta adecuada de vitaminas y minerales. Comer
                        variedad ayuda a cubrir todas las necesidades nutricionales. <br />
                ...
                <section className=' mt-16 flex flex-col items-baseline'>
                    ...
                    <article className='bg-gray-600 rounded-xl p-2 sm:p-6 text-start text-lg sm:text-2xl'>
                        ...
                        va a ser que vayas al gimnasio entre 4 o 5 veces a la semana (aunque si por alguna razón tenés que ir menos, lo podés
