            ...
            <main className='mx-4'>
                <section className='mt-16 flex flex-col items-baseline'>
                    ...
                    <article className='bg-zinc-900 rounded-xl p-2 sm:p-6 text-start text-lg sm:text-2xl'>
                        ...
                        Proteínas Magras: Pollo, pavo, pescado, huevos, legumbres, tofu y productos lácteos bajos en grasa. Aproximadamente 1.2 a 1.6 gramos de
                        proteína por kilogramo de peso corporal para preservar masa muscular mientras pierdes grasa. <br />
                        ...
                        moderada de carbohidratos para proporcionar energía sin excederte en calorías y la fibra te ayudará a mantenerte saciado. <br />
                        Grasas Saludables: Aguacate, nueces, semillas, aceite de oliva y pescado graso. Consume grasas en un 20-30% de tu ingesta calórica diaria,
                        enfocándote en grasas insaturadas para apoyar la salud general. <br />
                        ...
                        general. <br />
                        Hidratación: Bebe al menos 2 litros de agua al día. Mantener una buena hidratación es crucial para el metabolismo y la eliminación de toxinas. <br />
                ...
                <section className=' mt-16 flex flex-col items-baseline'>
                    ...
                    <article className='bg-gray-600 rounded-xl p-2 sm:p-6 text-start text-lg sm:text-2xl'>
                        Para una persona con un tipo de cuerpo endomorfo, que tiende a ganar peso fácilmente y tiene una mayor proporción de
                        grasa corporal, el enfoque principal del entrenamiento debe ser la pérdida de grasa y la ganancia muscular. Lo ideal
                        va a ser que vayas al gimnasio aproximadamente 4 veces a la semana (aunque si por alguna razón tenés que ir menos, lo podés
                        ir acomodando). Al finalizar tus entrenamientos, lo ideal sería que hagas entre 15 y 20 minutos de caminata o bici.
                    </article>
                </section>
...
export default ResultadoDieciocho;